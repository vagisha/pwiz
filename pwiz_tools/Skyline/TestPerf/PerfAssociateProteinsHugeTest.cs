    ...
    public class PerfAssociateProteinsHugeTest : AbstractFunctionalTest
    {
        ...
        private void TestDialog(ImportType type)
        {
            ...
            RunUI(() =>
            {
                ...
                dlg2.SelectedProteinParsimony = ProteinAssociation.ProteinParsimony.KeepAllProteins;
                ...
                dlg2.SelectedProteinParsimony = ProteinAssociation.ProteinParsimony.MinimalProteinList;
                ...
                Assert.AreEqual(711563, dlg2.FinalResults.FinalPeptideCount);
                Assert.AreEqual(42265, dlg2.FinalResults.FinalProteinCount);
