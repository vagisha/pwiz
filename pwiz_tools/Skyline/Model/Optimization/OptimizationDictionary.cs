    ...
    public class OptimizationDictionary : AbstractReadOnlyDictionary<OptimizationKey, double>
    {
        ...
        public IEnumerable<DbOptimization> EntriesMatching(OptimizationKey optimizationKey)
        {
            ...
            foreach (var indexItem in _libKeyMap.Index.ItemsMatching(GetPrecursorKey(optimizationKey), LibKeyIndex.LibraryMatchType.ion))
            {
                ...
                if (dict.TryGetValue(productKey, out value))
                {
                    var foundKey = new OptimizationKey(optimizationKey.OptType, indexItem.LibraryKey.Target, indexItem.LibraryKey.Adduct, indexItem.LibraryKey.IonMobility, optimizationKey.FragmentIon, optimizationKey.ProductAdduct);
        ...
        {
            return new LibKey(optimizationKey.PeptideModSeq, optimizationKey.PrecursorAdduct, optimizationKey.PrecursorIonMobility).LibraryKey;
        }
